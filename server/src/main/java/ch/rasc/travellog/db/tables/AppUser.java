...
public class AppUser extends TableImpl<AppUserRecord> {
   ...
   */
  public final TableField<AppUserRecord, String> EMAIL_NEW = createField(
      DSL.name("email_new"), org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(
  ...
  public final TableField<AppUserRecord, String> PASSWORD_HASH = createField(
      DSL.name("password_hash"), org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(
          org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)),
      this, "");
  ...
  public final TableField<AppUserRecord, String> AUTHORITY = createField(
      DSL.name("authority"), org.jooq.impl.SQLDataType.VARCHAR(10).nullable(false), this,
      "");
   ...
   */
  public final TableField<AppUserRecord, LocalDateTime> EXPIRED = createField(
      DSL.name("expired"),
  ...
  public final TableField<AppUserRecord, String> CONFIRMATION_TOKEN = createField(
      DSL.name("confirmation_token"), org.jooq.impl.SQLDataType.CHAR(35).defaultValue(
  ...
  public final TableField<AppUserRecord, String> PASSWORD_RESET_TOKEN = createField(
      DSL.name("password_reset_token"), org.jooq.impl.SQLDataType.CHAR(35).defaultValue(
          org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.CHAR)),
      this, "");
