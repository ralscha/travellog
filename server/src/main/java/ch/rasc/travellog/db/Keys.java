...
public class Keys {
    ...
    private static class Identities0 {
        ...
        public static Identity<LogPhotoRecord, Long> IDENTITY_LOG_PHOTO = Internal.createIdentity(LogPhoto.LOG_PHOTO, LogPhoto.LOG_PHOTO.ID);
        public static Identity<TravelRecord, Long> IDENTITY_TRAVEL = Internal.createIdentity(Travel.TRAVEL, Travel.TRAVEL.ID);
    }
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<LogPhotoRecord> KEY_LOG_PHOTO_PRIMARY = Internal.createUniqueKey(LogPhoto.LOG_PHOTO, "KEY_log_photo_PRIMARY", LogPhoto.LOG_PHOTO.ID);
        public static final UniqueKey<TravelRecord> KEY_TRAVEL_PRIMARY = Internal.createUniqueKey(Travel.TRAVEL, "KEY_travel_PRIMARY", Travel.TRAVEL.ID);
    }

    private static class ForeignKeys0 {
        public static final ForeignKey<AppSessionRecord, AppUserRecord> APP_SESSION_IBFK_1 = Internal.createForeignKey(ch.rasc.travellog.db.Keys.KEY_APP_USER_PRIMARY, AppSession.APP_SESSION, "app_session_ibfk_1", AppSession.APP_SESSION.APP_USER_ID);
        public static final ForeignKey<LogRecord, TravelRecord> LOG_IBFK_1 = Internal.createForeignKey(ch.rasc.travellog.db.Keys.KEY_TRAVEL_PRIMARY, Log.LOG, "log_ibfk_1", Log.LOG.TRAVEL_ID);
        public static final ForeignKey<LogPhotoRecord, LogRecord> LOG_PHOTO_IBFK_1 = Internal.createForeignKey(ch.rasc.travellog.db.Keys.KEY_LOG_PRIMARY, LogPhoto.LOG_PHOTO, "log_photo_ibfk_1", LogPhoto.LOG_PHOTO.LOG_ID);
        public static final ForeignKey<TravelRecord, AppUserRecord> TRAVEL_IBFK_1 = Internal.createForeignKey(ch.rasc.travellog.db.Keys.KEY_APP_USER_PRIMARY, Travel.TRAVEL, "travel_ibfk_1", Travel.TRAVEL.APP_USER_ID);
    }
}
