...
public class Log extends TableImpl<LogRecord> {
     ...
     */
    public final TableField<LogRecord, LocalDateTime> CREATED = createField(DSL.name("created"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("current_timestamp()", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>log.lat</code>.
     */
    public final TableField<LogRecord, BigDecimal> LAT = createField(DSL.name("lat"), SQLDataType.DECIMAL(10, 8).nullable(false), this, "");

    /**
     * The column <code>log.lng</code>.
     */
    public final TableField<LogRecord, BigDecimal> LNG = createField(DSL.name("lng"), SQLDataType.DECIMAL(11, 8).nullable(false), this, "");

    /**
     * The column <code>log.location</code>.
     */
    public final TableField<LogRecord, String> LOCATION = createField(DSL.name("location"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>log.report</code>.
     */
    public final TableField<LogRecord, String> REPORT = createField(DSL.name("report"), SQLDataType.CLOB.defaultValue(DSL.field("NULL", SQLDataType.CLOB)), this, "");

    /**
     * The column <code>log.travel_id</code>.
     */
    public final TableField<LogRecord, Long> TRAVEL_ID = createField(DSL.name("travel_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>log.updated</code>.
     */
    public final TableField<LogRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("'0000-00-00 00:00:00'", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public Travel travel() {
        if (_travel == null)
            _travel = new Travel(this, Keys.LOG_IBFK_1);
     ...
     */
    public <U> SelectField<U> mapping(Function8<? super Long, ? super LocalDateTime, ? super BigDecimal, ? super BigDecimal, ? super String, ? super String, ? super Long, ? super LocalDateTime, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function8<? super Long, ? super LocalDateTime, ? super BigDecimal, ? super BigDecimal, ? super String, ? super String, ? super Long, ? super LocalDateTime, ? extends U> from) {
