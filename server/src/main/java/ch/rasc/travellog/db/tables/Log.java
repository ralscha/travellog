...
public class Log extends TableImpl<LogRecord> {
     ...
     */
    public final TableField<LogRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>log.created</code>.
     */
    public final TableField<LogRecord, LocalDateTime> CREATED = createField(DSL.name("created"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("current_timestamp()", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>log.lat</code>.
     */
    public final TableField<LogRecord, BigDecimal> LAT = createField(DSL.name("lat"), org.jooq.impl.SQLDataType.DECIMAL(10, 8).nullable(false), this, "");

    /**
     * The column <code>log.lng</code>.
     */
    public final TableField<LogRecord, BigDecimal> LNG = createField(DSL.name("lng"), org.jooq.impl.SQLDataType.DECIMAL(11, 8).nullable(false), this, "");

    /**
     * The column <code>log.location</code>.
     */
    public final TableField<LogRecord, String> LOCATION = createField(DSL.name("location"), org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>log.report</code>.
     */
    public final TableField<LogRecord, String> REPORT = createField(DSL.name("report"), org.jooq.impl.SQLDataType.CLOB.defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.CLOB)), this, "");

    /**
     * The column <code>log.travel_id</code>.
     */
    public final TableField<LogRecord, Long> TRAVEL_ID = createField(DSL.name("travel_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>log.updated</code>.
     */
    public final TableField<LogRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("'0000-00-00 00:00:00'", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");
