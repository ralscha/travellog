...
public class LogPhotoRecord extends UpdatableRecordImpl<LogPhotoRecord> implements Record11<Long, String, String, String, Integer, Long, LocalDateTime, BigDecimal, BigDecimal, byte[], String> {
    ...
    @Override
    public LogPhotoRecord values(Long value1, String value2, String value3, String value4, Integer value5, Long value6, LocalDateTime value7, BigDecimal value8, BigDecimal value9, byte[] value10, String value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogPhotoRecord(Long id, String subject, String name, String mimeType, Integer size, Long logId, LocalDateTime updated, BigDecimal lat, BigDecimal lng, byte[] thumbnail, String storage) {
        super(LogPhoto.LOG_PHOTO);
