...
public class Travel extends TableImpl<TravelRecord> {
     ...
     */
    public final TableField<TravelRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>travel.name</code>.
     */
    public final TableField<TravelRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>travel.app_user_id</code>.
     */
    public final TableField<TravelRecord, Long> APP_USER_ID = createField(DSL.name("app_user_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>travel.updated</code>.
     */
    public final TableField<TravelRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("current_timestamp()", SQLDataType.LOCALDATETIME)), this, "");
    ...
    public AppUser appUser() {
        if (_appUser == null)
            _appUser = new AppUser(this, Keys.TRAVEL_IBFK_1);
