...
public class LogPhoto extends TableImpl<LogPhotoRecord> {
     ...
     */
    public final TableField<LogPhotoRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>log_photo.subject</code>.
     */
    public final TableField<LogPhotoRecord, String> SUBJECT = createField(DSL.name("subject"), SQLDataType.VARCHAR(255).defaultValue(DSL.field("NULL", SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>log_photo.name</code>.
     */
    public final TableField<LogPhotoRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>log_photo.mime_type</code>.
     */
    public final TableField<LogPhotoRecord, String> MIME_TYPE = createField(DSL.name("mime_type"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>log_photo.size</code>.
     */
    public final TableField<LogPhotoRecord, Integer> SIZE = createField(DSL.name("size"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>log_photo.log_id</code>.
     */
    public final TableField<LogPhotoRecord, Long> LOG_ID = createField(DSL.name("log_id"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>log_photo.updated</code>.
     */
    public final TableField<LogPhotoRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), SQLDataType.LOCALDATETIME(0).nullable(false).defaultValue(DSL.field("current_timestamp()", SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>log_photo.lat</code>.
     */
    public final TableField<LogPhotoRecord, BigDecimal> LAT = createField(DSL.name("lat"), SQLDataType.DECIMAL(10, 8).defaultValue(DSL.field("NULL", SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>log_photo.lng</code>.
     */
    public final TableField<LogPhotoRecord, BigDecimal> LNG = createField(DSL.name("lng"), SQLDataType.DECIMAL(11, 8).defaultValue(DSL.field("NULL", SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>log_photo.thumbnail</code>.
     */
    public final TableField<LogPhotoRecord, byte[]> THUMBNAIL = createField(DSL.name("thumbnail"), SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>log_photo.storage</code>.
     */
    public final TableField<LogPhotoRecord, String> STORAGE = createField(DSL.name("storage"), SQLDataType.VARCHAR(22).nullable(false), this, "");
    ...
    public Log log() {
        if (_log == null)
            _log = new Log(this, Keys.LOG_PHOTO_IBFK_1);
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super Long, ? super String, ? super String, ? super String, ? super Integer, ? super Long, ? super LocalDateTime, ? super BigDecimal, ? super BigDecimal, ? super byte[], ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super Long, ? super String, ? super String, ? super String, ? super Integer, ? super Long, ? super LocalDateTime, ? super BigDecimal, ? super BigDecimal, ? super byte[], ? super String, ? extends U> from) {
