...
public class LogPhoto extends TableImpl<LogPhotoRecord> {
     ...
     */
    public final TableField<LogPhotoRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>log_photo.subject</code>.
     */
    public final TableField<LogPhotoRecord, String> SUBJECT = createField(DSL.name("subject"), org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>log_photo.name</code>.
     */
    public final TableField<LogPhotoRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>log_photo.mime_type</code>.
     */
    public final TableField<LogPhotoRecord, String> MIME_TYPE = createField(DSL.name("mime_type"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>log_photo.size</code>.
     */
    public final TableField<LogPhotoRecord, Integer> SIZE = createField(DSL.name("size"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>log_photo.log_id</code>.
     */
    public final TableField<LogPhotoRecord, Long> LOG_ID = createField(DSL.name("log_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>log_photo.updated</code>.
     */
    public final TableField<LogPhotoRecord, LocalDateTime> UPDATED = createField(DSL.name("updated"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("current_timestamp()", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>log_photo.lat</code>.
     */
    public final TableField<LogPhotoRecord, BigDecimal> LAT = createField(DSL.name("lat"), org.jooq.impl.SQLDataType.DECIMAL(10, 8).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>log_photo.lng</code>.
     */
    public final TableField<LogPhotoRecord, BigDecimal> LNG = createField(DSL.name("lng"), org.jooq.impl.SQLDataType.DECIMAL(11, 8).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.DECIMAL)), this, "");

    /**
     * The column <code>log_photo.thumbnail</code>.
     */
    public final TableField<LogPhotoRecord, byte[]> THUMBNAIL = createField(DSL.name("thumbnail"), org.jooq.impl.SQLDataType.BLOB.nullable(false), this, "");

    /**
     * The column <code>log_photo.storage</code>.
     */
    public final TableField<LogPhotoRecord, String> STORAGE = createField(DSL.name("storage"), org.jooq.impl.SQLDataType.VARCHAR(22).nullable(false), this, "");
