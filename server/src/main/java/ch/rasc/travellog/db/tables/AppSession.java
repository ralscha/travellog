...
public class AppSession extends TableImpl<AppSessionRecord> {
     ...
     */
    public final TableField<AppSessionRecord, LocalDateTime> LAST_ACCESS = createField(DSL.name("last_access"), org.jooq.impl.SQLDataType.LOCALDATETIME.nullable(false).defaultValue(org.jooq.impl.DSL.field("current_timestamp()", org.jooq.impl.SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>app_session.ip</code>.
     */
    public final TableField<AppSessionRecord, String> IP = createField(DSL.name("ip"), org.jooq.impl.SQLDataType.VARCHAR(39).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>app_session.user_agent</code>.
     */
    public final TableField<AppSessionRecord, String> USER_AGENT = createField(DSL.name("user_agent"), org.jooq.impl.SQLDataType.VARCHAR(255).defaultValue(org.jooq.impl.DSL.field("NULL", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.APP_SESSION_APP_USER_ID, Indexes.APP_SESSION_PRIMARY);
    }
