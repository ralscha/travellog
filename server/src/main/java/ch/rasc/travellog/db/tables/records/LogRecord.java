...
public class LogRecord extends UpdatableRecordImpl<LogRecord> implements Record8<Long, LocalDateTime, BigDecimal, BigDecimal, String, String, Long, LocalDateTime> {
    ...
    @Override
    public LogRecord values(Long value1, LocalDateTime value2, BigDecimal value3, BigDecimal value4, String value5, String value6, Long value7, LocalDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogRecord(Long id, LocalDateTime created, BigDecimal lat, BigDecimal lng, String location, String report, Long travelId, LocalDateTime updated) {
        super(Log.LOG);
