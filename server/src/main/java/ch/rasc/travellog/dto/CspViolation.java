...
public class CspViolation {
  ...
  public String toString() {
    return "CspViolation [disposition=" + this.disposition + ", referrer=" + this.referrer
        + ", documentUri=" + this.documentUri + ", violatedDirective="
        + this.violatedDirective + ", effectiveDirective=" + this.effectiveDirective
        + ", originalPolicy=" + this.originalPolicy + ", blockedUri=" + this.blockedUri
        + ", lineNumber=" + this.lineNumber + ", columnNumber=" + this.columnNumber
        + ", statusCode=" + this.statusCode + ", sourceFile=" + this.sourceFile
        + ", scriptSample=" + this.scriptSample + "]";
  }
